...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(final ServerHttpSecurity security) {
        return security.authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers("/shopsphere/users/api/user/**").hasRole(BUYER)
                        .pathMatchers("/shopsphere/carts/api/user/**").hasRole(BUYER)
                        .pathMatchers("/shopsphere/orders/api/user/**").hasRole(BUYER)
